...
*/
var HTMLheaderName = '<div style="position:relative; text-align:center; margin-bottom:-30px;"><h1 id="name" style="font-family: deja-vu; font-size: 6em; color: #fff; text-shadow: #000000 15px 10px 12px;">%data%</h1>';
